...
OAuth2.prototype.openAuthorizationCodePopup = function(callback) {
  ...
  // it later.
  window['oauth-callback-' + this.adapterName] = callback;
...
OAuth2.prototype.finishAuth = function() {
  ...
  function callback(error) {
    ...
    for (var i = 0, view; view = views[i]; i++) {
      if (view['oauth-callback-' + this.adapterName]) {console.log(view['oauth-callback-' + this.adapterName]);
        view['oauth-callback-' + this.adapterName](error);
